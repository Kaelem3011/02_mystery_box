...
class Game:
    ...
    def reveal_boxes(self):
        ...
        copper = ["Mystery_box_images\copper_low.gif", "Mystery_box_images\copper_med.gif",
                  "Mystery_box_images\copper_high.gif"]
        silver = ["Mystery_box_images\silver_low.gif", "Mystery_box_images\silver_med.gif",
                  "Mystery_box_images\silver_high.gif"]
        gold = ["Mystery_box_images\gold_low.gif", "Mystery_box_images\gold_med.gif",
                "Mystery_box_images\gold_high.gif"]
...
class GameStats:
    def __init__(self, partner, game_history, game_stats):
        ...
        self.export_button = Button(self.export_dismiss_frame, text="Export", fg='white', bg='dark blue',
                                    font="Arial 12 bold",
                                    command=lambda: self.export(partner, game_history, game_stats))
